...
public class ListHospital extends ListActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ListHospital.this.setListAdapter(new ArrayAdapter<>(ListHospital.this, android.R.layout.simple_list_item_1, listHospital));
    }
    ...
    private void listHospitalClick(String strObject) {
        try {
            ...
            switch (strObject) {
                case "RS. Awal Bross" :
                    intent = new Intent(ListHospital.this, MenuAwalBross.class);
                    break;
                case "RS. Tabrani" :
                case "Eka Hospital" :
                case "RS. Aulia" :
